...
public class ModConfig {
    ...
    private static void setupConfig(ForgeConfigSpec.@NotNull Builder builder) {
        importantPaperChestSpawningProbability =
                builder.defineInRange("important_paper_chest_spawning_chance", 0.008, 0, 1);
        problemStatementSpawningProbability =
                builder.defineInRange("math_problem_statement_chest_spawning_chance", 0.008, 0, 1);
        emeraldPickaxeSpawningProbability =
                builder.defineInRange("emerald_pickaxe_chest_spawning_chance", 0.25, 0, 1);
